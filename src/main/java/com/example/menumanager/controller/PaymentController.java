...
public class PaymentController {
     ...
     * Returns a URL you can redirect the browser to.
     *
     * paymentMethod: CARD or ONLINE (treated the same for now; Stripe decides the actual methods).
     */
    ...
    public ResponseEntity<?> createCheckoutSession(
        ...
        try {
            ...
            // Use Stripe's {CHECKOUT_SESSION_ID} placeholder so we can verify payment on our server
            ...
            SessionCreateParams params = SessionCreateParams.builder()
                    ...
                    // Use a single line item: "Order #ID"
                    .addLineItem(SessionCreateParams.LineItem.builder()
                            ...
                            .setPriceData(SessionCreateParams.LineItem.PriceData.builder()
                                    ...
                                    .build())
                            .build())
                    // Metadata allows webhook to map payment -> orderId
