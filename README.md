...
| `PUBLIC_BASE_URL` | `https://digitalmenusystem.up.railway.app` | **CRITICAL: Your working Railway app URL (for QR codes & payments)** |
...
**⚠️ IMPORTANT:** The `PUBLIC_BASE_URL` must point to your active Railway service domain. QR codes generated by the app will use this URL, so they will fail with 404 if this is set to the wrong or inactive domain.
