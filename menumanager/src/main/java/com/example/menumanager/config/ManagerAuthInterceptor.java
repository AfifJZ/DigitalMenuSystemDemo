...
public class ManagerAuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // NOTE: Payout-account (Stripe Connect) gate removed. The user can
        // still register a bank on /manage/profile, but the rest of the app
    ...
    private boolean isSetupExemptPath(String path) {
        return path.startsWith("/manage/setup")
                ...
                || path.startsWith("/manage/profile")
